        ...
        <div class="col-md-3">
            <div class="card text-center border-primary">
                <div class="card-body">
                    ...
                    <h3 class="mt-2 mb-1 text-primary"><?php echo e($stats['total_cases']); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card text-center border-success">
                <div class="card-body">
                    ...
                    <h3 class="mt-2 mb-1 text-success"><?php echo e($stats['active_cases']); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card text-center border-danger">
                <div class="card-body">
                    ...
                    <h3 class="mt-2 mb-1 text-danger"><?php echo e($stats['overdue_cases']); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card text-center border-secondary">
                <div class="card-body">
                    ...
                    <h3 class="mt-2 mb-1 text-secondary"><?php echo e($stats['completed_cases']); ?></h3>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 hover-shadow">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('reports.case-summary')); ?>" class="btn btn-outline-primary w-100">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 hover-shadow">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('reports.performance')); ?>" class="btn btn-outline-primary w-100">
                        <i class="bi bi-eye me-2"></i>View Report
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 hover-shadow">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('reports.deadline-compliance')); ?>" class="btn btn-outline-primary w-100">
                        <i class="bi bi-eye me-2"></i>View Report
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 hover-shadow">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('reports.statistical')); ?>" class="btn btn-outline-primary w-100">
                        <i class="bi bi-eye me-2"></i>View Report
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\LAO Case Matrix System\CASE MATRIX SYSTEM\resources\views/reports/index.blade.php ENDPATH**/ ?>