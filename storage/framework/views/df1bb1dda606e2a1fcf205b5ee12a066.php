...
<?php $__env->startSection('page-subtitle', 'Comprehensive overview of your legal affairs office'); ?>
...
<div class="row g-3 mb-4">
    <div class="col-lg-3 col-md-6">
        <div class="lao-stat-card">
            ...
            <div class="lao-stat-value"><?php echo e($stats['total_active']); ?></div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="lao-stat-card">
            ...
            <div class="lao-stat-value"><?php echo e($stats['due_within_7days']); ?></div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="lao-stat-card">
            ...
            <div class="lao-stat-value"><?php echo e($stats['overdue']); ?></div>
            <small class="<?php echo e($stats['overdue'] > 0 ? 'text-danger fw-bold' : 'text-muted'); ?>">Immediate attention required</small>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="lao-stat-card">
            ...
            <div class="lao-stat-value"><?php echo e($stats['hearing_today']); ?></div>
...
<div class="row g-3 mb-4">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="lao-chart-card">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $casesBySection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="chart-bar">
                ...
                <div class="chart-bar-track">
                    <div class="chart-bar-fill" style="width: <?php echo e($stats['total_active'] > 0 ? ($count / $stats['total_active'] * 100) : 0); ?>%; background: var(--lao-primary);"></div>
                </div>
            </div>
    ...
    <div class="col-lg-4 col-md-6">
        <div class="lao-chart-card">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $casesByCourt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $court => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="chart-bar">
                <div class="chart-bar-label">
                    <span><?php echo e($court); ?></span>
                    <strong><?php echo e($count); ?></strong>
                </div>
                <div class="chart-bar-track">
                    <div class="chart-bar-fill" style="width: <?php echo e($stats['total_active'] > 0 ? ($count / $stats['total_active'] * 100) : 0); ?>%; background: var(--status-green);"></div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <p class="text-muted text-center py-3">No data available</p>
    ...
    <div class="col-lg-4 col-md-12">
        <div class="lao-chart-card">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $casesByRegion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="chart-bar">
                <div class="chart-bar-label">
                    <span><?php echo e($region); ?></span>
                    <strong><?php echo e($count); ?></strong>
                </div>
                <div class="chart-bar-track">
                    <div class="chart-bar-fill" style="width: <?php echo e($stats['total_active'] > 0 ? ($count / $stats['total_active'] * 100) : 0); ?>%; background: var(--status-yellow);"></div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <p class="text-muted text-center py-3">No data available</p>
...
<div class="row g-3">
    ...
    <div class="col-12">
        <div class="lao-card">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span class="lao-badge badge-danger"><?php echo e($overdueCases->count()); ?> Cases</span>
            </div>
            <div class="table-responsive">
                <table class="lao-table">
                    ...
                    <tbody>
                        ...
                        <tr class="status-red">
                            <td><strong><?php echo e($case->case_number); ?></strong></td>
                            <td><?php echo e($case->docket_no ?: '-'); ?></td>
                            <td><?php echo e(Str::limit($case->case_title, 40)); ?></td>
                            <td><?php echo e($case->client_name); ?></td>
                            <td><span class="lao-badge badge-secondary"><?php echo e($case->section); ?></span></td>
                            <td><span class="lao-badge badge-secondary"><?php echo e($case->court_agency ?: 'N/A'); ?></span></td>
                            <td><?php echo e($case->deadline_date->format('M d, Y')); ?></td>
                            <td>
                                <span class="lao-badge badge-danger">
                                    <i class="bi bi-x-circle-fill"></i> <?php echo e(abs($case->remaining_days)); ?> days
                                </span>
                            </td>
                            <td>
                                <a href="<?php echo e(route('cases.show', $case)); ?>" class="btn btn-sm btn-lao-primary">View</a>
                            </td>
                        </tr>
    ...
    <div class="col-12">
        <div class="lao-card">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span class="lao-badge badge-warning"><?php echo e($dueSoonCases->count()); ?> Cases</span>
            </div>
            <div class="table-responsive">
                <table class="lao-table">
                    <thead>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $dueSoonCases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="status-yellow">
                            ...
                            <td>
                                <span class="lao-badge badge-warning">
                                    <i class="bi bi-clock-fill"></i> <?php echo e($case->remaining_days); ?> days
                                </span>
                            </td>
                            <td>
                                <a href="<?php echo e(route('cases.show', $case)); ?>" class="btn btn-sm btn-lao-primary">View</a>
    ...
    <!-- Today's Hearings -->
    <?php if($hearingTodayCases->count() > 0): ?>
    <div class="col-12">
        <div class="lao-card">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0">
                ...
                <span class="lao-badge badge-success"><?php echo e($hearingTodayCases->count()); ?> Hearings</span>
            </div>
            <div class="table-responsive">
                <table class="lao-table">
                    <thead>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $hearingTodayCases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="status-green">
                            <td><strong><?php echo e($case->case_number); ?></strong></td>
                            <td><?php echo e(Str::limit($case->case_title, 50)); ?></td>
                            <td><?php echo e($case->client_name); ?></td>
                            <td><span class="lao-badge badge-secondary"><?php echo e($case->court_agency ?: 'N/A'); ?></span></td>
                            <td><?php echo e($case->assigned_lawyer ?: 'Unassigned'); ?></td>
                            <td>
                                <span class="lao-badge badge-success">
                                    <i class="bi bi-calendar-event"></i> <?php echo e($case->hearing_date->format('M d, Y')); ?>
    ...
    <!-- No Urgent Cases -->
    <?php if($overdueCases->count() == 0 && $dueSoonCases->count() == 0 && $hearingTodayCases->count() == 0): ?>
    <div class="col-12">
        <div class="lao-card text-center py-5">
            ...
            <a href="<?php echo e(route('cases.create')); ?>" class="btn btn-lao-primary mt-3">
...
(async function() {
    ...
    try {
        ...
        const overdueCaseCount = <?php echo e($overdueCases->count()); ?>;
        if (overdueCaseCount > 0) {
            setTimeout(async () => {
                await registration.showNotification('🚨 Overdue Cases Alert', {
                    ...
                    data: {
                        url: '<?php echo e(route("deadlines.index")); ?>',
        ...
        const dueSoonCount = <?php echo e($dueSoonCases->count()); ?>;
        if (dueSoonCount > 0) {
            setTimeout(async () => {
        ...
        const hearingTodayCount = <?php echo e($hearingTodayCases->count()); ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\LAO Case Matrix System\CASE MATRIX SYSTEM\resources\views/dashboard.blade.php ENDPATH**/ ?>