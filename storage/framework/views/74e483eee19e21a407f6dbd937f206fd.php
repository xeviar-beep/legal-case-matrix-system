...
<?php $__env->startSection('page-title', $case->case_number); ?>
<?php $__env->startSection('page-subtitle', $case->case_title); ?>
...
<!-- Case Status Alert -->
<?php if($case->status === 'overdue' && $case->deadline_date): ?>
<div class="alert alert-danger d-flex align-items-center mb-3" role="alert">
    <i class="bi bi-exclamation-triangle-fill me-2"></i>
    <div>
        <strong>OVERDUE:</strong> This case deadline passed <?php echo e(abs($case->remaining_days)); ?> days ago on <?php echo e($case->deadline_date->format('F d, Y')); ?>. Immediate action required!
    </div>
</div>
<?php elseif($case->status === 'due_soon' && $case->deadline_date): ?>
<div class="alert alert-warning d-flex align-items-center mb-3" role="alert">
    <i class="bi bi-clock-fill me-2"></i>
    <div>
        <strong>DUE SOON:</strong> This case deadline is in <?php echo e($case->remaining_days); ?> days on <?php echo e($case->deadline_date->format('F d, Y')); ?>. Please prepare submission.
    </div>
</div>
<?php endif; ?>
        ...
        <div class="table-container mb-3">
            <div class="table-header">
                ...
                <div class="d-flex gap-2">
                    <a href="<?php echo e(route('cases.edit', $case)); ?>" class="btn btn-primary btn-sm">
                        <i class="bi bi-pencil"></i> Edit Case
                    </a>
                    <a href="<?php echo e(route('cases.index')); ?>" class="btn btn-outline-secondary btn-sm">
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        <div class="mb-2">
                            ...
                            <div style="font-size: 15px; font-weight: 700; color: #000000;"><?php echo e($case->case_number); ?></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-2">
                            ...
                            <div style="font-size: 13px; font-weight: 600; color: #1a1a1a;"><?php echo e($case->docket_no ?: 'N/A'); ?></div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="mb-2">
                            ...
                            <div style="font-size: 14px; font-weight: 600; color: #000000;"><?php echo e($case->case_title); ?></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-2">
                            ...
                            <div style="font-size: 13px; font-weight: 600; color: #1a1a1a;"><?php echo e($case->client_name); ?></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-2">
                            ...
                            <div style="font-size: 13px; font-weight: 600; color: #1a1a1a;"><?php echo e($case->assigned_lawyer ?: 'Not Assigned'); ?></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-2">
                            ...
                            <div style="font-size: 14px; font-weight: 500;">
                                <?php if($case->section): ?>
                                    <span class="badge bg-primary"><?php echo e($case->section); ?></span>
                                <?php else: ?>
                    ...
                    <div class="col-md-4">
                        <div class="mb-2">
                            ...
                            <div style="font-size: 13px; font-weight: 600; color: #1a1a1a;"><?php echo e($case->case_type ?: 'N/A'); ?></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-2">
                            ...
                            <div>
                                ...
                                <?php else: ?>
                                    <span class="badge bg-secondary"><?php echo e(ucfirst($case->status)); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mb-2">
                            ...
                            <div style="font-size: 13px; font-weight: 600; color: #1a1a1a;">
                                <?php if($case->court_agency): ?>
                                    ...
                                    <span class="text-muted ms-2" style="font-size: 12px; font-weight: 500;"><?php echo e($courtNames[$case->court_agency] ?? $case->court_agency); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-2">
                            ...
                            <div style="font-size: 13px; font-weight: 600; color: #1a1a1a;">
                                <i class="bi bi-calendar3"></i> <?php echo e($case->date_filed ? $case->date_filed->format('M d, Y') : 'Not set'); ?>
                    ...
                    <div class="col-md-4">
                        <div class="mb-2">
                            ...
                            <div style="font-size: 13px; font-weight: 600; color: #1a1a1a;">
                                <i class="bi bi-calendar-x"></i> <?php echo e($case->deadline_date ? $case->deadline_date->format('M d, Y') : 'Not set'); ?>
                            ...
                            <div>
                                <?php if($case->status === 'overdue'): ?>
                                    <span class="badge badge-overdue" style="font-size: 11px; padding: 6px 10px;">
                                        <i class="bi bi-x-circle-fill"></i> <?php echo e(abs($case->remaining_days)); ?> DAYS OVERDUE
                                    </span>
                                <?php elseif($case->status === 'due_soon'): ?>
                                    <span class="badge badge-due-soon" style="font-size: 11px; padding: 6px 10px;">
                                        <i class="bi bi-clock-fill"></i> <?php echo e($case->remaining_days); ?> DAYS LEFT
                                    </span>
                                <?php else: ?>
                                    <span class="badge badge-active" style="font-size: 11px; padding: 6px 10px;">
                                        <i class="bi bi-check-circle-fill"></i> <?php echo e($case->remaining_days); ?> DAYS LEFT
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-2">
                            ...
                            <div style="font-size: 13px; font-weight: 600; color: #1a1a1a;">
                                <i class="bi bi-calendar-event text-success"></i> <?php echo e($case->hearing_date->format('M d, Y')); ?>
                    ...
                    <div class="col-12">
                        <div class="mb-0">
                            ...
                            <div style="font-size: 13px; color: #1a1a1a; line-height: 1.5; font-weight: 500;"><?php echo e($case->description); ?></div>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="timeline">
                    ...
                    <div class="d-flex mb-2">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div style="font-size: 11px; color: #6b7280; font-weight: 600;"><?php echo e($case->date_filed->format('M d, Y')); ?></div>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="d-flex mb-2">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div style="font-size: 11px; color: #6b7280; font-weight: 600;"><?php echo e($case->hearing_date->format('M d, Y')); ?></div>
                        </div>
                    </div>
                    <?php endif; ?>

                    <!-- Deadline Event -->
                    <?php if($case->deadline_date): ?>
                    <div class="d-flex">
                        <div class="me-2">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div style="font-size: 11px; color: #6b7280; font-weight: 600;"><?php echo e($case->deadline_date->format('M d, Y')); ?></div>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="text-center p-3" style="background: var(--lao-gray); border-radius: 8px;">
                        <?php if($case->status === 'overdue'): ?>
                            ...
                            <p style="font-size: 12px; color: #1a1a1a; margin: 0; font-weight: 600;">
                                <?php echo e(abs($case->remaining_days)); ?> days past deadline
                            </p>
                        <?php elseif($case->status === 'due_soon'): ?>
                            ...
                            <p style="font-size: 12px; color: #1a1a1a; margin: 0; font-weight: 600;">
                                <?php echo e($case->remaining_days); ?> days remaining
                            </p>
                        <?php else: ?>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-12">
                            <div class="p-2" style="background: #f9fafb; border-radius: 6px;">
                                ...
                                <div style="font-size: 13px; font-weight: 700; color: #000000;">
                                    <i class="bi bi-calendar3"></i> <?php echo e($case->date_filed->format('M d, Y')); ?>
                        ...
                        <div class="col-12">
                            <div class="p-2" style="background: #f9fafb; border-radius: 6px;">
                                ...
                                <div style="font-size: 13px; font-weight: 700; color: #000000;" class="<?php echo e($case->status === 'overdue' ? 'text-danger' : ''); ?>">
                                    <i class="bi bi-flag-fill"></i> <?php echo e($case->deadline_date->format('M d, Y')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\LAO Case Matrix System\CASE MATRIX SYSTEM\resources\views/cases/show.blade.php ENDPATH**/ ?>