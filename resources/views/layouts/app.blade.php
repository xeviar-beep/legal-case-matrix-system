...
<head>
    ...
    <title>@yield('title') - LAO Case Tracking System</title>
...
<body>
    ...
    <aside class="lao-sidebar">
        <div class="lao-sidebar-header">
            <a href="{{ route('dashboard') }}" class="lao-logo">
        ...
        <nav class="lao-nav">
            <div class="lao-nav-section">
                <div class="lao-nav-item">
                    <a href="{{ route('dashboard') }}" class="lao-nav-link {{ request()->routeIs('dashboard') ? 'active' : '' }}">
                ...
                <div class="lao-nav-item has-dropdown" data-dropdown-id="cases-dropdown">
                    <a href="javascript:void(0)" class="lao-nav-link {{ request()->routeIs('cases.*') ? 'active' : '' }}" data-toggle-dropdown>
                    ...
                    <div class="lao-nav-dropdown">
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index') }}" class="lao-nav-dropdown-link {{ request()->routeIs('cases.index') && !request()->routeIs('cases.information') ? 'active' : '' }}">
                                <i class="bi bi-list-ul"></i>
                                <span>All Cases</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.information') }}" class="lao-nav-dropdown-link {{ request()->routeIs('cases.information') ? 'active' : '' }}">
            ...
            <div class="lao-nav-section">
                ...
                <div class="lao-nav-item has-dropdown" data-dropdown-id="sections-dropdown">
                    <a href="javascript:void(0)" class="lao-nav-link {{ request()->routeIs('sections.*') ? 'active' : '' }}" data-toggle-dropdown>
                        <div style="display: flex; align-items: center; gap: 12px;">
                    ...
                    <div class="lao-nav-dropdown">
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['section' => 'Criminal']) }}" class="lao-nav-dropdown-link {{ request()->get('section') == 'Criminal' ? 'active' : '' }}">
                                <i class="bi bi-shield-exclamation"></i>
                                <span>Criminal</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['section' => 'Civil']) }}" class="lao-nav-dropdown-link {{ request()->get('section') == 'Civil' ? 'active' : '' }}">
                                <i class="bi bi-file-text"></i>
                                <span>Civil</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['section' => 'Labor']) }}" class="lao-nav-dropdown-link {{ request()->get('section') == 'Labor' ? 'active' : '' }}">
                                <i class="bi bi-briefcase"></i>
                                <span>Labor</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['section' => 'Administrative']) }}" class="lao-nav-dropdown-link {{ request()->get('section') == 'Administrative' ? 'active' : '' }}">
                                <i class="bi bi-building"></i>
                                <span>Administrative</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['section' => 'Special']) }}" class="lao-nav-dropdown-link {{ request()->get('section') == 'Special' ? 'active' : '' }}">
                ...
                <div class="lao-nav-item has-dropdown" data-dropdown-id="courts-dropdown">
                    <a href="javascript:void(0)" class="lao-nav-link {{ request()->routeIs('courts.*') ? 'active' : '' }}" data-toggle-dropdown>
                        <div style="display: flex; align-items: center; gap: 12px;">
                    ...
                    <div class="lao-nav-dropdown">
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['court' => 'SC']) }}" class="lao-nav-dropdown-link {{ request()->get('court') == 'SC' ? 'active' : '' }}">
                                <i class="bi bi-trophy"></i>
                                <span>Supreme Court</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['court' => 'CA']) }}" class="lao-nav-dropdown-link {{ request()->get('court') == 'CA' ? 'active' : '' }}">
                                <i class="bi bi-building"></i>
                                <span>Court of Appeals</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['court' => 'RTC']) }}" class="lao-nav-dropdown-link {{ request()->get('court') == 'RTC' ? 'active' : '' }}">
                                <i class="bi bi-bank2"></i>
                                <span>Regional Trial Court</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['court' => 'OMB']) }}" class="lao-nav-dropdown-link {{ request()->get('court') == 'OMB' ? 'active' : '' }}">
                                <i class="bi bi-shield-check"></i>
                                <span>Office of the Ombudsman</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['court' => 'NCIP']) }}" class="lao-nav-dropdown-link {{ request()->get('court') == 'NCIP' ? 'active' : '' }}">
                ...
                <div class="lao-nav-item has-dropdown" data-dropdown-id="regions-dropdown">
                    <a href="javascript:void(0)" class="lao-nav-link {{ request()->routeIs('regions.*') ? 'active' : '' }}" data-toggle-dropdown>
                        <div style="display: flex; align-items: center; gap: 12px;">
                    ...
                    <div class="lao-nav-dropdown">
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'NCR']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'NCR' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>NCR</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region I']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region I' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region I - Ilocos</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region II']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region II' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region II - Cagayan Valley</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region III']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region III' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region III - Central Luzon</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region IV-A']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region IV-A' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region IV-A - CALABARZON</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region V']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region V' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region V - Bicol</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region IV-B']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region IV-B' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region IV-B - MIMAROPA</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region VI']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region VI' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region VI - Western Visayas</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region VII']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region VII' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region VII - Central Visayas</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region VIII']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region VIII' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region VIII - Eastern Visayas</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region IX']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region IX' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region IX - Zamboanga Peninsula</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region X']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region X' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region X - Northern Mindanao</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region XI']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region XI' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region XI - Davao</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region XII']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region XII' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region XII - SOCCSKSARGEN</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'Region XIII']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'Region XIII' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>Region XIII - Caraga</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'CAR']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'CAR' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>CAR - Cordillera</span>
                            </a>
                        </div>
                        <div class="lao-nav-dropdown-item">
                            <a href="{{ route('cases.index', ['region' => 'BARMM']) }}" class="lao-nav-dropdown-link {{ request()->get('region') == 'BARMM' ? 'active' : '' }}">
                                <i class="bi bi-geo-alt"></i>
                                <span>BARMM</span>
                            </a>
                        </div>
            ...
            <div class="lao-nav-section">
                ...
                <div class="lao-nav-item">
                    <a href="{{ route('deadlines.index') }}" class="lao-nav-link {{ request()->routeIs('deadlines.*') ? 'active' : '' }}">
                ...
                <div class="lao-nav-item">
                    <a href="{{ route('cases.index', ['status' => 'completed']) }}" class="lao-nav-link {{ request()->get('status') == 'completed' ? 'active' : '' }}">
                ...
                <div class="lao-nav-item">
                    <a href="{{ route('notifications.index') }}" class="lao-nav-link {{ request()->routeIs('notifications.*') ? 'active' : '' }}">
            ...
            <div class="lao-nav-section">
                ...
                <div class="lao-nav-item">
                    <a href="{{ route('reports.index') }}" class="lao-nav-link {{ request()->routeIs('reports.*') ? 'active' : '' }}">
                ...
                <div class="lao-nav-item">
                    <a href="{{ route('admin.index') }}" class="lao-nav-link {{ request()->routeIs('admin.*') ? 'active' : '' }}">
            ...
            <div class="lao-notification-wrapper">
                ...
                <div class="notification-dropdown" id="notificationDropdown">
                    ...
                    <div class="notification-dropdown-footer">
                        ...
                        <a href="{{ route('notifications.index') }}" class="btn btn-sm btn-outline-primary w-100">See All Notifications</a>
                    </div>
                </div>
            </div>
            ...
            <div class="lao-user-profile-wrapper">
                <div class="lao-user-profile" onclick="toggleUserDropdown()">
                    ...
                    <div class="lao-user-info d-none d-md-block">
                        <div class="lao-user-name">{{ Auth::user()->name }}</div>
                        <div class="lao-user-role">{{ ucfirst(Auth::user()->role) }}</div>
                    </div>
                ...
                <div class="user-dropdown" id="userDropdown">
                    <div class="user-dropdown-header">
                        <div class="user-dropdown-user">
                            <div class="user-dropdown-avatar">
                                @if(Auth::user()->profile_picture)
                                    <img src="{{ Auth::user()->profile_picture_url }}" alt="{{ Auth::user()->name }}" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                                @else
                                    {{ Auth::user()->initials }}
                                @endif
                            </div>
                    ...
                    <div class="user-dropdown-body">
                        ...
                        <a href="{{ route('admin.index') }}" class="user-dropdown-item">
    ...
    <main class="lao-main">
        ...
        <div class="lao-page-header">
            <h1 class="lao-page-title">@yield('page-title', 'Dashboard')</h1>
            <p class="lao-page-subtitle">@yield('page-subtitle', 'Welcome to LAO Case Tracking System')</p>
        </div>
    ...
    <script>
        ...
        window.sendTestNotification = async function() {
            ...
            try {
                ...
                const response = await fetch('{{ route("cases.testNotificationData") }}', {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
                ...
                const caseUrl = result.case_id ? `/cases/${result.case_id}` : '{{ route("dashboard") }}';
