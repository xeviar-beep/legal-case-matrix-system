...
@section('title', $courtName . ' Cases')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-building me-2 icon-building"></i>{{ $courtName }}</h2>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('courts.index') }}">Courts & Agencies</a></li>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        ">
                            ...
                            <td>
                                @if($case->region)
                                    <span class="badge bg-info">{{ $case->region }}</span>
                                @else
                                    <span class="text-muted">-</span>
                                @endif
                            </td>
