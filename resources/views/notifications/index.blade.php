        ...
        <div class="col-md-3">
            <div class="card text-center border-primary">
                <div class="card-body">
                    ...
                    <h3 class="mt-2 mb-1 text-primary">{{ $stats['total'] }}</h3>
        ...
        <div class="col-md-3">
            <div class="card text-center border-danger">
                <div class="card-body">
                    ...
                    <h3 class="mt-2 mb-1 text-danger">{{ $stats['critical'] }}</h3>
        ...
        <div class="col-md-3">
            <div class="card text-center border-warning">
                <div class="card-body">
                    ...
                    <h3 class="mt-2 mb-1 text-warning">{{ $stats['warning'] }}</h3>
        ...
        <div class="col-md-3">
            <div class="card text-center border-info">
                <div class="card-body">
                    ...
                    <h3 class="mt-2 mb-1 text-info">{{ $stats['info'] }}</h3>
    ...
    <ul class="nav nav-tabs mb-3" id="notificationTabs" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="critical-tab" data-bs-toggle="tab" data-bs-target="#critical" type="button">
                <span class="text-danger">Critical ({{ $stats['critical'] }})</span>
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="warning-tab" data-bs-toggle="tab" data-bs-target="#warning" type="button">
                <span class="text-warning">Warning ({{ $stats['warning'] }})</span>
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="info-tab" data-bs-toggle="tab" data-bs-target="#info" type="button">
                <span class="text-info">Info ({{ $stats['info'] }})</span>
            </button>
        </li>
    </ul>
    ...
    <div class="tab-content" id="notificationTabsContent">
            ...
            @if($allNotifications->count() > 0)
                <div class="card">
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{ route('cases.show', $notification['case']) }}" class="list-group-item notification-item {{ $notification['type'] }} notification-clickable" data-type="{{ $notification['type'] }}">
                                ...
                                <div class="flex-grow-1 w-100">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 gap-md-3 align-items-center">
                                        <small class="text-muted">
                                            <i class="bi bi-person"></i> {{ $notification['case']->client_name }}
                                        </small>
                                        @if($notification['case']->section)
                                        <small>
                                            <span class="badge bg-secondary">{{ $notification['case']->section }}</span>
                                        </small>
                                        @endif
                                        @if($notification['case']->assigned_lawyer)
                                        <small class="text-muted">
                                            <i class="bi bi-briefcase"></i> {{ $notification['case']->assigned_lawyer }}
                                        </small>
                                        @endif
                                        <small class="text-muted">
        ...
        <div class="tab-pane fade" id="critical" role="tabpanel">
            @if($stats['critical'] > 0)
                <div class="card">
                    <div class="list-group list-group-flush">
                        @foreach($allNotifications->where('type', 'critical') as $notification)
                        <a href="{{ route('cases.show', $notification['case']) }}" class="list-group-item notification-item critical notification-clickable">
                            <div class="d-flex w-100 flex-column flex-md-row justify-content-between align-items-start">
                                <div class="flex-grow-1 w-100">
                                    <div class="d-flex align-items-center mb-2">
                                        <i class="bi bi-exclamation-triangle-fill text-danger fs-5 me-2"></i>
        ...
        <div class="tab-pane fade" id="warning" role="tabpanel">
            @if($stats['warning'] > 0)
                <div class="card">
                    <div class="list-group list-group-flush">
                        @foreach($allNotifications->where('type', 'warning') as $notification)
                        <a href="{{ route('cases.show', $notification['case']) }}" class="list-group-item notification-item warning notification-clickable">
                            <div class="d-flex w-100 flex-column flex-md-row justify-content-between align-items-start">
                                <div class="flex-grow-1 w-100">
                                    <div class="d-flex align-items-center mb-2">
                                        <i class="bi bi-exclamation-circle-fill text-warning fs-5 me-2"></i>
        ...
        <div class="tab-pane fade" id="info" role="tabpanel">
            @if($stats['info'] > 0)
                <div class="card">
                    <div class="list-group list-group-flush">
                        @foreach($allNotifications->where('type', 'info') as $notification)
                        <a href="{{ route('cases.show', $notification['case']) }}" class="list-group-item notification-item info notification-clickable">
                            <div class="d-flex w-100 flex-column flex-md-row justify-content-between align-items-start">
                                <div class="flex-grow-1 w-100">
                                    <div class="d-flex align-items-center mb-2">
                                        <i class="bi bi-info-circle-fill text-info fs-5 me-2"></i>
